...
//
//    page = new PageWrapper<Company>();
//    pageR = new PageWrapper<Company>(1, new ArrayList<Company>(), 10, 12);
//
//    Mockito.when(companyDao.findOne(1l)).thenReturn(Company.builder().id(1l).name("truc").build());
