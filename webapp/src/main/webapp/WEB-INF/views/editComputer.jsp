    ...
    <section id="main">
        <div class="container">
        	<span style="float: right"> 
				<a href="?id=${computerDto.id}&lang=en" class="btn btn-primary">en</a>
				<a href="?id=${computerDto.id}&lang=fr" class="btn btn-primary">fr</a>
			</span>
            <div class="row">
                    ...
                    <form:form id="form" action="editcomputer" method="POST" commandName="computerDto">
                        ...
                        <fieldset>
                        	<div class="form-group">
                                ...
                                <form:input path="name" type="text" class="form-control" id="computerName" placeholder="${namePlaceholder}" value="${computerDto.name}" required="required"/>
                            ...
                            <div class="form-group">
                                ...
                                <form:input path="introduced" type="date" class="form-control" id="introduced" placeholder="${introducedPlaceholder}" value="${computerDto.introduced}"/>
                            ...
                            <div class="form-group">
                                ...
                                <form:input path="discontinued" type="date" class="form-control" id="discontinued" placeholder="${discontinuedPlaceholder}" value="${computerDto.discontinued}"/>
                            ...
                            <div class="form-group">
                                ...
                                <form:select path="idCompany" class="form-control" id="idCompany">
                                    ...
                                    <c:forEach items="${companies}" var="company">
	                                   	<c:if test="${company.id == computerDto.idCompany}">
