...
public class ComputerWebServiceImpl implements ComputerWebService {
  ...
  public ComputerWebServiceImpl(ComputerDBService computerDBService,
  ...
  public ArrayList<ComputerDto> getAll() {
    return (ArrayList<ComputerDto>) computerDtoMapper
        .toDto(computerDBService.getAll(), DATE_FORMAT);
  }
